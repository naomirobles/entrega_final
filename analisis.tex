...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pngs/e_r.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{pngs/procesos.png}
...
\begin{figure}[H]
    ...
    \caption{Caso de uso 1: Gestión de Tareas}
\end{figure}

\subsection{Recomendaciones}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{pngs/uc_2.png}
    \caption{Caso de uso 2: Recomendaciones y Recursos (APIs externas)}
\end{figure}
\subsection{Administración}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{pngs/uc_3.png}
    \caption{Caso de uso 3: Administración}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{pantallas/landing_page.png}
    \caption{Landing Page}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{pantallas/calendar.png}
    \caption{Vista de Calendario de Tareas}
\end{figure}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{pantallas/Modal para añadir tarea.png}
    \caption{Modal para Agregar Nueva Tarea}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{pantallas/Modal para ver tarea.png}
    \caption{Modal para Ver Detalles de Tarea y Recomendaciones}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{pantallas/modal para añadir categoria.png}
    \caption{Modal para crear o editar una categoría}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{pantallas/register.png}
    \caption{Pantalla para crear una cuenta}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{pantallas/register2.png}
    \caption{Pantalla para ingresar datos de registro}
\end{figure}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \caption{Pantalla para administrar Perfil de Usuario}
\end{figure}
\newpage
\pagestyle{fancy}
