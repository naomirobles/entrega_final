...
\begin{itemize}
    \item Una computadora por desarrollador con las siguientes características mínimas:
    ...
    \item El desarrollador de ML debe contar con un equipo capaz de probar modelos LLM:
    
    \begin{tablaAru}
        Procesador & Intel Core i5/i7 de 8ª generación o AMD Ryzen 5/7 (al menos 4 núcleos físicos). \\
        Memoria RAM & Mínimo: 16 GB RAM. \\
        Almacenamiento & 256 GB SSD. \\
        GPU & GPU con 6 GB VRAM (ejemplo: NVIDIA GTX 1660 Ti, RTX 2060). \\
    \end{tablaAru}
    
    \item Entorno local para alojamiento de la aplicación:
    
    \begin{tablaAru}
        Procesador & Intel Core i5/i7 de 8ª generación o AMD Ryzen 5/7. \\
        Memoria RAM & Mínimo: 16 GB RAM. \\
        Almacenamiento & 256 GB SSD. \\
        GPU & GPU con 6 GB VRAM. \\
    \end{tablaAru}
\end{itemize}
...
\afterpage{
    \clearpage % Fuerza la impresión de cualquier tabla o lista pendiente
    \begin{landscape}
        \centering % Centra el diagrama en la hoja
        \noindent
        \begin{ganttchart}[
            hgrid,
            vgrid,
            x unit=0.16cm,           % Reducido de 0.192 a 0.16
            y unit chart=0.5cm,      % Reducido de 0.7 a 0.5
            time slot format=isodate,
            time slot unit=day,
            % Reducción de fuentes para ganar espacio horizontal
            ...
            group/.style={draw=black, fill=gray!12, rounded corners=2pt, font=\scriptsize\bfseries}
