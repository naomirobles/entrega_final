...
\begin{itemize}
    ...
    \begin{aruTable}{}
        Procesador:     & Intel Core i3 de 7ª generación o AMD equivalente (2 núcleos, 2.0 GHz o más). \\ \hline
        Memoria RAM:    & Al menos 4 GB  \\ \hline
    ...
    \begin{aruTable}{}
        Procesador:     & Intel Core i5/i7 de 8ª gen o AMD Ryzen 5/7 (4 núcleos físicos). \\ \hline
        Memoria RAM:    & Mínimo: 16 GB RAM  \\ \hline
        Almacenamiento: & 256 GB SSD \\ \hline
        Tarjeta Gráfica:& GPU con 6 GB VRAM (ej. NVIDIA GTX 1660 Ti, RTX 2060). \\
    \end{aruTable}
    
    \item Entorno local para despliegue (características similares a ML):
